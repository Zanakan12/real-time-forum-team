export function RegisterPage() {
    ...
    <table class="post">
        ...
        <tr>
            <td><label for="email">{{.Register.EmailLabel}}</label></td>
            <td><input type="email" id="email" name="email" required></td>
        </tr>
        <tr>
            <td><label for="username">{{.Register.UsernameLabel}}</label></td>
            <td><input type="text" id="username" name="username" required></td>
        </tr>
        <tr>
            <td><label for="password">{{.Register.PasswordLabel}}</label></td>
